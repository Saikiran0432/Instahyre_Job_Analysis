...
import pandas as pd
import requests
#Taking required urls into a list
...
for url in urls:
    ...
    if request.status_code==200:
        ...
        for new_column in data:
            skills_require=new_column['keywords']
            required_data={'skills_requried':skills_require}
            final_data.append(required_data)

    else:
        print('request status error',request.status_code)
df=pd.DataFrame(final_data)
excel_file='D:/Project/Project/Table3.xlsx'
